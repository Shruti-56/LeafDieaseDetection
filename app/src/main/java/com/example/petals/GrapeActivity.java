...
import com.example.petals.ml.GrapeInt8;
...
//        }
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(GrapeActivity.this);
        builder.setTitle("Add Photo!");
        builder.setItems(options, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                try {
                    if (ContextCompat.checkSelfPermission(GrapeActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED &&
                            ContextCompat.checkSelfPermission(GrapeActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED &&
                            ContextCompat.checkSelfPermission(GrapeActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

                        ActivityCompat.requestPermissions(GrapeActivity.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
...
//                            belly.setImageDrawable();
    ...
    public void classifyImage(Bitmap image){
        ...
        try {
            GrapeInt8 model = GrapeInt8.newInstance(GrapeActivity.this);
            ...
            GrapeInt8.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"Grape has Esca (Black rot)", "Grape has Black Measles ","Grape has Leaf blight","Grape is healthy"};
            ...
            if (maxPos == 0){
                ...
                description.setText(str_Grape_Blackrot);
            }else if (maxPos == 1){
                description.setVisibility(View.VISIBLE);
                description.setText(str_Grape_Esca);
            } else if (maxPos == 2){
                description.setVisibility(View.VISIBLE);
                description.setText(str_Leaf_blight);
            } else if (maxPos == 3) {
                description.setVisibility(View.VISIBLE);
                description.setText(str_Grape_healthy);
            }
